...
public class TestDomainClass {
	...
	public static void emfSetup() throws Exception {
		...
		String dbLocation = TestDomainClass.class.getResource("/testdb.accdb").getPath();
	...
	public static Collection<Object[]> getDomainClasses() {
		Reflections reflections = new Reflections("org.sharks.storage.domain", new SubTypesScanner(false));
	...
	public TestDomainClass(Class<Object> domainClass) {
